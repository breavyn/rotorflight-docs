...
If using the governor you must first enable the [RPM Measurement](/rotorflight-docs/docs/setup/rpm-measurement.md) and configure the [Governor](/rotorflight-docs/docs/configurator/tabs/governor.md)
