...
These tuning parameters are located on the Profile tab in the [Configurator](/rotorflight-docs/docs/configurator/tabs/profiles.md) and could also be changed via the [LUA Scripts](/rotorflight-docs/docs/setup/lua-scripts.mdx) or [Adjustments](/rotorflight-docs/docs/configurator/tabs/adjustments.md)
...
What do we mean "wobble"?? When tuning parameters are too high the helicopter will wobble or shake during some movements. Each time we increase a tuning value we need to test fly and see if the new setting is too high. Test this in the following way:
...
* Advanced: Do crazy high speed high rate stuff that makes the FC sweat and see if it freaks out
  <!-- -->
  😜
  <!-- -->
  .

## Please also see the General Guidelines below for more specific descriptions[​](#please-also-see-the-general-guidelines-below-for-more-specific-descriptions "Direct link to Please also see the General Guidelines below for more specific descriptions")
