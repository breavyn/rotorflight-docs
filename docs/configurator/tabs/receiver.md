...
## Receiver Configuration[​](#receiver-configuration "Direct link to Receiver Configuration")

First activate `Serial Rx` on the UART you have connected your receiver.

![](/rotorflight-docs/assets/images/receiver-uart-7416596949fba9e87a369262792ff2d3.png)

## Receiver Options[​](#receiver-options "Direct link to Receiver Options")
...
![](/rotorflight-docs/assets/images/receiver-options-fea484e526b4be7451ef3e774e6f442b.png)
...
## Receiver Type[​](#receiver-type "Direct link to Receiver Type")
...
* Protocols that do not have telemetry are still compatible with Rotorflight (and transmitters without Lua Scripting); however, [Adjustments](/rotorflight-docs/docs/configurator/tabs/adjustments.md) have to be configured in order to tune from your radio.
...
![](/rotorflight-docs/assets/images/receiver-crsf-e3ffbc36ab13ef9adcb87d11e9dbe02d.png)

* SBUS needs to be connected to an RX pad.

![](/rotorflight-docs/assets/images/receiver-sbus-5bc1a2817336468219e671f75aa42d95.png)

* SBUS2 needs to be connected to an TX pad.

![](/rotorflight-docs/assets/images/receiver-sbus2-d0392ab8ec9de97a1c0db58227ff0cc5.png)
...
![](/rotorflight-docs/assets/images/receiver-fbus-e4ef05d0c4e9cc29ed3d81e75174eb3f.png)

* F.Port needs be connected to a TX pad, with `Inverted Serial Signaling` activated ,and `Half-Duplex` activated.

![](/rotorflight-docs/assets/images/receiver-fport-1c9188ae432de7effb57cff6541246e8.png)
...
## Receiver Channels[​](#receiver-channels "Direct link to Receiver Channels")
...
![](/rotorflight-docs/assets/images/receiver-channels-fa4b700f4d43e4f49f46c259a84a3465.png)

## Channel Range[​](#channel-range "Direct link to Channel Range")
...
Calibrating Stability Mode The stability modes (Angle, Horizon or Rescue) can be calibrated so that the heli doesn't drift much when using such a mode. This can only be done via the [accelerometer trims](/rotorflight-docs/docs/setup/using-stability-modes-example.md). **Do not use trim on your transmitter**.

You should end up with something similar to this:

![](/rotorflight-docs/assets/images/tx-output-calibrated-24f660212880e31d7b3fcc7f09a49801.gif)
...
![](/rotorflight-docs/assets/images/receiver-channel-range-52d1c2f8bd145af5d00eefa2fa6b3ad3.png)

* **Automatic Throttle Range** - This will automatically set the throttle channel range based on the minimum and maximum values received from the receiver. This is the recommended setting for most users, as it will automatically adjust to any changes in your transmitter settings. If you disable this option, you will need to manually set the throttle channel range using the `Throttle Channel value for 0% throttle` and `Throttle Channel value for 100% throttle` options.

![](/rotorflight-docs/assets/images/receiver-throttle-range-ac868bf8f91f5e41e4ce92e1c01cf6ad.png)

## Telemetry Sensors[​](#telemetry-sensors "Direct link to Telemetry Sensors")
...
![](/rotorflight-docs/assets/images/receiver-telem-sensors-9923bb6881400d8fb7a4c6290054113d.png)

tip

For ELRS receivers, follow the [ELRS Custom Telemetry](/rotorflight-docs/docs/setup/elrs-custom-telemetry.md) page for how to setup. This is new for Rotorflight 2.1 and ELRS Reuse is no longer available.
