...
[Flashing Rotorflight firmware](/rotorflight-docs/docs/setup/flashing-the-firmware.md)

### Remap Betaflight board[​](#remap-betaflight-board "Direct link to Remap Betaflight board")

[Remapping servos and motors](/rotorflight-docs/docs/setup/remapping.md)
...
* There are enough connections (pads) for the servos, ELRS and -optional- an [OpenLager](/rotorflight-docs/docs/setup/openlager.md) blackbox logging device.

The receiver used here is a [BETAFPV ELRS Lite](https://betafpv.com/products/elrs-lite-receiver).

![M1](/rotorflight-docs/assets/images/m1-darwinfpv-right-987f944058e8b42db7298affb10d64e7.jpg)
...
* The servo connectors are three Molex PicoBlade connectors glued together (similar to [this bus](/rotorflight-docs/docs/setup/led-strip-quick-start.md#building-the-picoblade-bus)), then connected to the FC using 5 wires (5V/GND using 28AWG, S1/S2/S3 with 30AWG). The underside of the bus is reinforced and insulated with epoxy.
...
* The ESCs were flashed with [Bluejay](/rotorflight-docs/docs/setup/blheli_s-to-bluejay.md) version 0.21, so we can use bi-directional Dshot with RPM telemetry for filtering and governing.
...
![M1](/rotorflight-docs/assets/images/m1-darwinfpv-left-16479546a717ccd5c7cb511347514041.jpg)
...
![M1](/rotorflight-docs/assets/images/m1-darwinfpv-15a-pins-36a61b5f3e1f12b8f0e2451b46dc2f15.png)

ELRS is on RX1/TX1/4.5V (so it also powers up when connecting USB), OpenLager is on TX2.

Here's the complete [`diff all`](/rotorflight-docs/assets/files/m1-diff-all-e4ce777ac60e581886f8634adfbbe570.txt).
...
![T-REX 150X](/rotorflight-docs/assets/images/trex-150x-mpu6500-ab7b9d8d0feb86c6264a91722a5a3347.jpg)
