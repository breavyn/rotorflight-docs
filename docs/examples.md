...
6. Select [Battery Voltage and Current Source](/rotorflight-docs/configurator/tabs/power.md#battery) as per you setup, and Set Battery [Capacity](/rotorflight-docs/configurator/tabs/power.md#capacity) and [Cell Count](/rotorflight-docs/configurator/tabs/power.md#cell-count).
...
8. Optional: Select and Setup the [Governor](/rotorflight-docs/docs/configurator/tabs/governor.md).
...
11. Setup the [Gyro RPM Filters](/rotorflight-docs/docs/setup/rpm-filters.md#rpm-filters-1).
...
17. Optional: Setup [LUA Script](/rotorflight-docs/setup/lua-scripts.mdx#introduction) on radio.
