...
**Governor Mode** - Set this to "Mode 1". This will control the Headspeed and provide slow spoolup.<br /><!-- -->See the [**Governor setup**](/rotorflight-docs/docs/configurator/tabs/governor.md) for details and examples.
