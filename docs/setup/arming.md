...
## Transmitter configuration[​](#transmitter-configuration "Direct link to Transmitter configuration")
...
![Arming](/rotorflight-docs/assets/images/arming-1-5fe514c9a745bb437b7b12444d7ccd80.png)

This simply switches the Arm channel (CH5/Aux1) from 0% (1000us) to 100% (2000us).

[](/rotorflight-docs/assets/medias/arming-2-3e68bf89080a2b721ab93fb20c92412c.mp4)

## Flight Controller configuration[​](#flight-controller-configuration "Direct link to Flight Controller configuration")

As shown in the video below:<br />**1.** Open the [Modes tab](/rotorflight-docs/docs/configurator/tabs/modes.md)<br />**2.** Set the channel to match your switch (in this case AUX1)<br />**3.** Drag the sliders to the top end of the channel<br />**4.** Save<br />**5.** Toggle the channel and watch the red indicator pip move. When it is inside the upper range the ARM box turns red.<br />**Note** **-** The box shows as **"(Disabled)"** because it is connected to the Configurator.

[](/rotorflight-docs/assets/medias/arming-3-abe4beb9a101d11e9543bfaedca797c3.mp4)

## Swashplate Wiggle indication[​](#swashplate-wiggle-indication "Direct link to Swashplate Wiggle indication")

The swashplate is configured to indicated ready for Arming as well as Errors. More details can be found on the [Swashplate wiggle](/rotorflight-docs/docs/setup/swash-wiggle.md) page.

## Arming Disable flags[​](#arming-disable-flags "Direct link to Arming Disable flags")

The Arming disable flags are a list of issues that could be preventing your helicopter from Arming. These are things like Gyro not configured, Receiver fail or throttle not at minimum. Please see the list below for details of each flag and how to fix it.
...
### Configurator[​](#configurator "Direct link to Configurator")

The Arming disable flags are displayed on the Status tab. Disable flag **MSP** means you are connected to the configurator.

![Arming](/rotorflight-docs/assets/images/arming-4-a7ba593d30f73860d2151a10dcb37850.png)

You can enable arming while connected to the configurator by the selecting the **enable arming** toggle.<br />**WARNING** this should only be done with blades off!!

![Arming](/rotorflight-docs/assets/images/arming-5-583614d507dd12bb1481d7c837a158fd.png)

### Edge Tx Lua[​](#edge-tx-lua "Direct link to Edge Tx Lua")

From the Edge Tx Rotorflight Lua click on the Status tab to view the disable flags.

![Arming](/rotorflight-docs/assets/images/arming-6-02478183330d4c9bf78ece04fb63d1a7.png)

### Ethos Tx Lua[​](#ethos-tx-lua "Direct link to Ethos Tx Lua")

Open the Rotorflight Lua, scroll to the bottom and click on the status tab.

![Arming](/rotorflight-docs/assets/images/arming-7-42af63bc76cc99753519927137536bfa.png)

## Disable flags description[​](#disable-flags-description "Direct link to Disable flags description")
...
| \ 'GOVERNOR'   | Governor enabled but no valid 'fast' RPM source (RPM frequency input or bi-directional D-shot) OR Gov mode 2 and no Voltage input configured.                                                                                                                                                                          |
| 'THROTTLE'     | Lower throttle below [Throttle Channel value for arming](/rotorflight-docs/docs/configurator/tabs/receiver.md#receiver-settings)                                                                                                                                                                                       |
...
| 'LOAD'         | System load is too high. This may happen with some low spec boards. Reduce the [PID loop frequency](/rotorflight-docs/docs/configurator/tabs/configuration.md#system-configuration) and/or number of filters                                                                                                           |
