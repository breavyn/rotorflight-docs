...
const sidebars = {
  ...
  tutorialSidebar: [
      ...
      items: [
        {
          ...
          items: [
            ...
            },
            {
              type: "category",
              label: "Futaba",
              items: ["setup/radio-setup/radio-setup-futaba/futaba-setup"],
            },
            {
              type: "category",
              label: "Jeti",
              items: ["setup/radio-setup/radio-setup-jeti/jeti-setup"],
            },
            {
              type: "category",
              label: "Others",
              items: ["setup/radio-setup/radio-setup-others/others"],
            },
          ],
        },
    ...
    },
    {
      ...
      label: "Tuning",
      collapsed: true,
      items: [{ type: "autogenerated", dirName: "Tuning" }],
    },
  ],
};
